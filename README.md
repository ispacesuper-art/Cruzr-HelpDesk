...
**Current version:** 2.5 · **Package:** `com.usc.cruzr.helpdesk`
...
| `VoiceAssistantController` | Pause/restore Cruzr voice assistant (AssistantManager keep-alive) |
...
```
app/build/outputs/apk/release/USC-Cruzr-HelpDesk-v2.5-release.apk
release/USC-Cruzr-HelpDesk-v2.5-release.apk
```
...
2. Upload `USC-Cruzr-HelpDesk-v2.5-release.apk`
...
adb install -r "release\USC-Cruzr-HelpDesk-v2.5-release.apk"
```
...
| Mic busy / voice assistant interference | Deploy **v2.5+** — assistant is suppressed every 2 s via AssistantManager while app is open. |
